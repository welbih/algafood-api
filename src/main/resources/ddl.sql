...
create table estado (id bigint not null auto_increment, nome varchar(255), uf varchar(255), primary key (id)) engine=InnoDB
...
create table produto (id bigint not null auto_increment, ativo bit not null, descricao varchar(255), nome varchar(255), preco decimal(19,2), restaurante_id bigint, primary key (id)) engine=InnoDB
